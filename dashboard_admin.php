    ...
    <main id="main-container" class="container py-5">
        <div class="row">
            <div class="col-12">
                ...
                <div id="dashboard-buttons" class="dashboard-buttons d-flex flex-column align-items-center flex-lg-row justify-content-lg-around mb-5">
                    <div class="dashboard-card">
                        <a href="<?= $BASE_URL ?>/profile_admin.php?id=<?= $user->getId() ?>">
                            <div class="text-center">
                                <img class="card-image" src="images/profile.png" alt="Profile">
                                <h4>Meu perfil</h4>
                            </div>
                        </a>
                    </div>
                    <div class="dashboard-card">
                        <a href="<?= $BASE_URL ?>/users_list.php?id=<?= $user->getId() ?>">
                            <div class="text-center">
                                <img class="card-image" src="images/users.png" alt="Utilizadores">
                                <h4>Utilizadores</h4>
                            </div>
                        </a>
                    </div>
                    <div class="dashboard-card">
                        <a href="<?= $BASE_URL ?>/meetings_list.php?id=<?= $user->getId() ?>">
                            <div class="text-center">
                                <img class="card-image" src="images/meetings.png" alt="Agendamentos">
                                <h4>Agendamentos</h4>
                            </div>
                        </a>
                    </div>
                    <div class="dashboard-card">
                        <a href="<?= $BASE_URL ?>/projects.php?id=<?= $user->getId() ?>">
                            <div class="text-center">
                                <img class="card-image" src="images/projects.png" alt="Projetos">
                                <h4>Projetos</h4>
                            </div>
                        </a>
                    </div>
                    <div class="dashboard-card">
                        <a href="<?= $BASE_URL ?>/news.php?id=<?= $user->getId() ?>">
                            <div class="text-center">
                                <img class="card-image" src="images/news.png" alt="Notícias">
                                <h4>Notícias</h4>
                            </div>
                        </a>
                    </div>

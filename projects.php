                ...
                <div class="row">
                    <div id="projects-box" class="col col-xl-10 mx-auto">
                        ...
                        <div class="table-responsive-sm">
                            <table class="table table-hover table-fixed" id="projects-table">
                                <thead>
                                    <tr class="table-primary">
                                        <th scope="col" class="d-table-cell">Título</th>
                                        <th scope="col" class="d-none d-lg-table-cell">Imagem</th>
                                        <th scope="col" class="d-table-cell">Descrição</th>
                                        <th scope="col" class="d-table-cell">Tecnologia</th>
                                        <th scope="col" class="d-none d-lg-table-cell">Tempo de conclusão</th>
                                ...
                                <tbody>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td class='d-none d-lg-table-cell py-3'><a href='projects_img/" . $row["imagem"] . "'><img src='projects_img/" . $row["imagem"] . "' alt='" . $row["titulo"] . "_img'</a></td>";
                                            echo "<td class='d-table-cell py-3'>" . $row["descricao"] . "</td>";
                        ...
                        <div class="row mt-5">
                            <div class="col-10 col-md-8 col-lg-6 col-xl-5 mx-auto bg-light p-4">
                                ...
                                <h3 class="text-center">Inserir novo projeto</h3>

                                <form method="post" action="includes/insert_project.inc.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mt-4 mb-4">
                                        ...
                                        <input type="text" class="form-control" name="tempo_gasto" required>
                                    </div>

                                    <div class="form-group mt-4 text-center">
                                        <input type="submit" name="submit" class="btn" id="insert-project-btn" value="Inserir projeto">
                                    </div>
